...
$url_retorno = $idioma == 'es'?URL.'/promociones':URL.'/en/offers';
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){ 
    ...
    if($recaptcha->score >= 0){
        ...
        $titulo = strip_tags(strtolower($_POST["formulario_titulo"]));
        ...
        if( 
            ...
            $mail->Subject    = "Formulario de Promociones Dreams Wedding " . $origen ;

            $mail->MsgHTML($body);
            $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

            $address = "web@eze-trip.com";
