<?php
	...
	$table_title = 'Descripcion Destinos';
...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"destinos_desc","title":"Descripcion Destinos","primary_key":0,"columns":[{"name":"id_destino_desc","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_destino","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"destinos","key_name":"id_destino","column_name":"nombre"},"select":false},{"name":"id_idioma","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"idiomas","key_name":"id_idioma","column_name":"siglas"}},{"name":"nombre","data_type":"s","field_type":"1","max_size":100},{"name":"nombre_corto","data_type":"s","field_type":"1","max_size":150,"select_name":"Nombre Corto"},{"name":"nombre_largo","data_type":"s","field_type":"1","max_size":200,"select_name":"Nombre Largo"},{"name":"descripcion","data_type":"s","field_type":"2"},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/destinos_desc.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en destinos_desc');
								window.location = "../catalogos/destinos_desc.php";
							}else{
								alert('No insertó en destinos_desc');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_destino_desc":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_destino_desc":"'+$('#f_id_destino_desc').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en destinos_desc');
								window.location = "../catalogos/destinos_desc.php";
							}else{
								alert('No actualizó en destinos_desc');
							}
						}else{
							alert('Error:'+res['error']);
						}
