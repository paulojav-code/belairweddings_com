...
?>
        ...
        <script>
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/idiomas.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en idiomas');
								window.location = "../catalogos/idiomas.php";
							}else{
								alert('No insertó en idiomas');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_idioma":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_idioma":"'+$('#f_id_idioma').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en idiomas');
								window.location = "../catalogos/idiomas.php";
							}else{
								alert('No actualizó en idiomas');
							}
						}else{
							alert('Error:'+res['error']);
						}
