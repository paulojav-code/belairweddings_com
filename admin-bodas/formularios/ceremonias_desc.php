<?php
	...
	$table_title = 'Descripcion Ceremonias';
...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"ceremonias_desc","title":"Descripcion Ceremonias","primary_key":0,"columns":[{"name":"id_ceremonia_desc","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_ceremonia","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"ceremonias","key_name":"id_ceremonia","column_name":[{"column":"id_novie","data":{"table_name":"novies","key_name":"id_novie","column_name":"nombre","field_column_name":"novies","concat":["person_1","&39; &39;","conector","&39; &39;","person_2"],"select_name":"Novies"}},{"column":"id_tipo_ceremonia","data":{"table_name":"tipos_ceremonias","key_name":"id_tipo_ceremonia","column_name":"nombre","field_column_name":"nombre","select_name":"Tipo Ceremonia"}}],"order_by":"id_ceremonia,orden"},"select_name":"Tipo Ceremonia"},{"name":"id_idioma","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"idiomas","key_name":"id_idioma","column_name":"siglas"}},{"name":"descripcion","data_type":"s","field_type":"2"},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/ceremonias_desc.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
			...
			function request_insert() {
                ...
                $.ajax({
                    data: dataString,
                    url: '../request/ceremonias_desc.php',
                    type: 'POST',
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en ceremonias_desc');
								window.location = "../catalogos/ceremonias_desc.php";
							}else{
								alert('No insertó en ceremonias_desc');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_ceremonia_desc":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_ceremonia_desc":"'+$('#f_id_ceremonia_desc').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en ceremonias_desc');
								window.location = "../catalogos/ceremonias_desc.php";
							}else{
								alert('No actualizó en ceremonias_desc');
							}
						}else{
							alert('Error:'+res['error']);
						}
