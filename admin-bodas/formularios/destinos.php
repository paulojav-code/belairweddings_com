...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"destinos","title":"Destinos","primary_key":0,"columns":[{"name":"id_destino","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"nombre","data_type":"s","field_type":"1","max_size":100},{"name":"lat","data_type":"s","field_type":"1","max_size":20,"select_name":"Latitud"},{"name":"lon","data_type":"s","field_type":"1","max_size":20,"select_name":"Longitud"},{"name":"carpeta","data_type":"s","field_type":"1","max_size":300},{"name":"banner","data_type":"s","field_type":"1","max_size":300},{"name":"mini","data_type":"s","field_type":"1","max_size":300},{"name":"galeria","data_type":"i","field_type":"1"},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/destinos.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en destinos');
								window.location = "../catalogos/destinos.php";
							}else{
								alert('No insertó en destinos');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_destino":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_destino":"'+$('#f_id_destino').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en destinos');
								window.location = "../catalogos/destinos.php";
							}else{
								alert('No actualizó en destinos');
							}
						}else{
							alert('Error:'+res['error']);
						}
