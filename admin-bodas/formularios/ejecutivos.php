...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"ejecutivos","title":"Ejecutivos","primary_key":0,"columns":[{"name":"id_ejecutivo","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"nombre","data_type":"s","field_type":"1","max_size":100},{"name":"paterno","data_type":"s","field_type":"1","max_size":50},{"name":"materno","data_type":"s","field_type":"1","max_size":50},{"name":"correo","data_type":"s","field_type":"1","max_size":100},{"name":"telefono","data_type":"s","field_type":"1","max_size":30},{"name":"extencion","data_type":"s","field_type":"1","max_size":30},{"name":"genero","data_type":"i","field_type":"1"},{"name":"tipo","data_type":"i","field_type":"1"},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/ejecutivos.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en ejecutivos');
								window.location = "../catalogos/ejecutivos.php";
							}else{
								alert('No insertó en ejecutivos');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_ejecutivo":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_ejecutivo":"'+$('#f_id_ejecutivo').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en ejecutivos');
								window.location = "../catalogos/ejecutivos.php";
							}else{
								alert('No actualizó en ejecutivos');
							}
						}else{
							alert('Error:'+res['error']);
						}
