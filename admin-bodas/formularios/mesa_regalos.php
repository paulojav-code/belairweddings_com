...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"mesa_regalos","title":"Mesa de Regalos","primary_key":0,"columns":[{"name":"id_mesa_regalo","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_novie","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"novies","key_name":"id_novie","column_name":"id_novie","concat":["person_1","&39; &39;","conector","&39; &39;","person_2"],"select_name":"Novies"}},{"name":"id_idioma","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"idiomas","key_name":"id_idioma","column_name":"siglas"}},{"name":"titulo","data_type":"s","field_type":"1","max_size":300},{"name":"descripcion","data_type":"s","field_type":"2"},{"name":"enlace","data_type":"s","field_type":"1","max_size":300},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/mesa_regalos.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en mesa_regalos');
								window.location = "../catalogos/mesa_regalos.php";
							}else{
								alert('No insertó en mesa_regalos');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_mesa_regalo":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_mesa_regalo":"'+$('#f_id_mesa_regalo').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en mesa_regalos');
								window.location = "../catalogos/mesa_regalos.php";
							}else{
								alert('No actualizó en mesa_regalos');
							}
						}else{
							alert('Error:'+res['error']);
						}
