...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"hoteles","title":"Hoteles","primary_key":0,"columns":[{"name":"id_hotel","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_destino","data_type":"i","field_type":"0","foreign":{"table_name":"destinos","key_name":"id_destino","column_name":"nombre"}},{"name":"nombre","data_type":"s","field_type":"1","max_size":100},{"name":"clave_hotel","data_type":"s","field_type":"1","max_size":10},{"name":"check_in","data_type":"s","field_type":"1","max_size":20},{"name":"check_out","data_type":"s","field_type":"1","max_size":20},{"name":"carpeta","data_type":"s","field_type":"1","max_size":100},{"name":"logo","data_type":"s","field_type":"1","max_size":100},{"name":"banner","data_type":"s","field_type":"1","max_size":300},{"name":"mini","data_type":"s","field_type":"1","max_size":300},{"name":"galeria","data_type":"i","field_type":"1"},{"name":"direccion","data_type":"s","field_type":"1","max_size":500},{"name":"mapa","data_type":"s","field_type":"1","max_size":300},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/hoteles.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en hoteles');
								window.location = "../catalogos/hoteles.php";
							}else{
								alert('No insertó en hoteles');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_hotel":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_hotel":"'+$('#f_id_hotel').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en hoteles');
								window.location = "../catalogos/hoteles.php";
							}else{
								alert('No actualizó en hoteles');
							}
						}else{
							alert('Error:'+res['error']);
						}
