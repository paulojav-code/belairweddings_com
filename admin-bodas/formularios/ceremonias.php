...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"ceremonias","title":"Ceremonias","primary_key":0,"columns":[{"name":"id_ceremonia","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_novie","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"novies","key_name":"id_novie","column_name":"id_novie","concat":["person_1","&39; &39;","conector","&39; &39;","person_2"],"select_name":"novies"}},{"name":"id_tipo_ceremonia","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"tipos_ceremonias","key_name":"id_tipo_ceremonia","column_name":"nombre"}},{"name":"orden","data_type":"i","field_type":"1"},{"name":"fecha","data_type":"s","field_type":"3"},{"name":"hora","data_type":"s","field_type":"1","max_size":10,"default":"00:00:00"},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/ceremonias.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
			...
			function print_select(res,col,id) {
				...
				for (let i = 0; i < res.length; i++) {
					if(Array.isArray(col['foreign']['column_name'])){
						...
						console.log(col['foreign']['column_name']);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en ceremonias');
								//window.location = "../catalogos/ceremonias.php";
								window.location = "../formularios/ceremonias.php";
							}else{
								alert('No insertó en ceremonias');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_ceremonia":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_ceremonia":"'+$('#f_id_ceremonia').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en ceremonias');
								window.location = "../catalogos/ceremonias.php";
							}else{
								alert('No actualizó en ceremonias');
							}
						}else{
							alert('Error:'+res['error']);
						}
