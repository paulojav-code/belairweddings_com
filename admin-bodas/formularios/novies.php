...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"novies","title":"Novies","primary_key":0,"columns":[{"name":"id_novie","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_ejecutivo","data_type":"i","field_type":"0","foreign":{"table_name":"ejecutivos","key_name":"id_ejecutivo","column_name":"nombre","concat":["nombre","&39; &39;","paterno"],"select_name":"Ejecutivo"}},{"name":"id_ejecutivo_publico","data_type":"i","field_type":"0","foreign":{"table_name":"ejecutivos","key_name":"id_ejecutivo","column_name":"nombre","concat":["nombre","&39; &39;","paterno"],"select_name":"Ejecutivo Publico"},"select":false},{"name":"id_hotel","data_type":"i","field_type":"0","foreign":{"table_name":"hoteles","key_name":"id_hotel","column_name":"nombre","select_name":"Hotel"}},{"name":"person_1","data_type":"s","field_type":"1","max_size":100,"select_name":"Novie 1"},{"name":"person_2","data_type":"s","field_type":"1","max_size":100,"select_name":"Novie 2"},{"name":"conector","data_type":"s","field_type":"1","max_size":10,"select":false,"default":"&"},{"name":"categoria_parejas","data_type":"i","field_type":"1","select_name":"Categoria Parejas","select":false,"default":"0"},{"name":"permitido_ninos","data_type":"i","field_type":"1","select_name":"Permitido Ni\u00f1os","select":false,"default":"1"},{"name":"asistencia","data_type":"i","field_type":"1","select_name":"Formulario Asistencia","select":false,"default":"1"},{"name":"fecha","data_type":"s","field_type":"3"},{"name":"tiempo","data_type":"s","field_type":"1","select":false,"default":"00:00:00"},{"name":"ruta","data_type":"s","field_type":"1","max_size":150},{"name":"cover_desk","data_type":"s","field_type":"1","max_size":300,"select_name":"Imagen Cover","default":"img\/cover.jpg"},{"name":"cover_mobile","data_type":"s","field_type":"1","max_size":300,"select_name":"Imagen Mobile"},{"name":"mini_small","data_type":"s","field_type":"1","max_size":300,"select_name":"Mini Cuadrado","default":"img\/mini-small.jpg"},{"name":"mini_large","data_type":"s","field_type":"1","max_size":300,"select_name":"Mini Largo","default":"img\/mini-large.jpg"},{"name":"mini_novie","data_type":"s","field_type":"1","max_size":300,"select_name":"Imagen Novies","default":"img\/form.jpg"},{"name":"mini_ceremonia","data_type":"s","field_type":"1","max_size":300,"select_name":"Imagen Ceremonias"},{"name":"galeria","data_type":"i","field_type":"1"},{"name":"copia","data_type":"s","field_type":"1"},{"name":"clave_evento","data_type":"s","field_type":"1","max_size":20,"select_name":"Clave Evento"},{"name":"idiomas","data_type":"s","field_type":"1","max_size":50},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/novies.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en novies');
								//window.location = "../catalogos/novies.php";
								window.location = "../formularios/novies_desc.php";
							}else{
								alert('No insertó en novies');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_novie":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_novie":"'+$('#f_id_novie').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en novies');
								window.location = "../catalogos/novies.php";
							}else{
								alert('No actualizó en novies');
							}
						}else{
							alert('Error:'+res['error']);
						}
