<?php
	...
	$table_title = 'Dirección Ceremonias';
...
?>
		...
		?>
        <script>
			var tabla = jQuery.parseJSON('{"name":"ceremonias_direccion","title":"Direcci\u00f3n Ceremonias","primary_key":0,"columns":[{"name":"id_ceremonia_direccion","data_type":"i","field_type":"1","primary_key":true,"insert":false},{"name":"id_ceremonia","data_type":"i","field_type":"0","primary_key":true,"foreign":{"table_name":"ceremonias","key_name":"id_ceremonia","column_name":[{"column":"id_novie","data":{"table_name":"novies","key_name":"id_novie","column_name":"novies","field_column_name":"novies","concat":["person_1","&39; &39;","conector","&39; &39;","person_2"],"select_name":"Novies"}},{"column":"id_tipo_ceremonia","data":{"table_name":"tipos_ceremonias","key_name":"id_tipo_ceremonia","column_name":"nombre","field_column_name":"nombre","select_name":"Tipo Ceremonia"}}]},"select_name":"Tipo Ceremonia"},{"name":"nombre","data_type":"s","field_type":"1","max_size":300},{"name":"direccion","data_type":"s","field_type":"1","max_size":500},{"name":"mapa","data_type":"s","field_type":"1","max_size":300},{"name":"activo","data_type":"i","field_type":"1","insert":false}]}');
			...
			function print_fields(id) {
				...
				fields += '</div>';
				fields += '<div class="col-12"><br><ul class="actions"><li><a class="button primary small">Guardar Nuevo</a></li><li><a class="button small" href="../catalogos/ceremonias_direccion.php">Cancelar</a></li></li></ul></div>';
				$('#content').html(fields);
			...
			function request_insert() {
                ...
                $.ajax({
                    data: dataString,
                    url: '../request/ceremonias_direccion.php',
                    type: 'POST',
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['insert'] > 0){
								print_fields(0);
								alert('Se insertó en ceremonias_direccion');
								window.location = "../catalogos/ceremonias_direccion.php";
							}else{
								alert('No insertó en ceremonias_direccion');
							}
						}else{
			...
			function request_data(id) {
				var dataString = 'request={"type":"4","id_ceremonia_direccion":"'+id+'"}';
			...
			function request_update() {
				var dataString = 'request={"type":"2","id_ceremonia_direccion":"'+$('#f_id_ceremonia_direccion').val()+'",';
					for (let i = 0; i < tabla['columns'].length; i++) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(typeof(res['error']) == "undefined"){
							if(res['update'] > 0){
								print_fields();
								alert('Se actualizó en ceremonias_direccion');
								window.location = "../catalogos/ceremonias_direccion.php";
							}else{
								alert('No actualizó en ceremonias_direccion');
							}
						}else{
							alert('Error:'+res['error']);
						}
